...
class ChoreForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'assigned_to': forms.SelectMultiple(attrs={'class': 'select2 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline'}),
            'due_date': forms.DateTimeInput(attrs={'type': 'text', 'class': 'flatpickr shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline'}),
